# 3 filamentos — chaveiro "AM Mulheres no Tatame"

A pele vira branco — rosto e quimono na mesma cor, como um desenho de uma cor só. O degrau do queixo é o que segura a forma da cabeça.

**Quando usar:** **É a que eu recomendo.** Melhor equilíbrio entre poucas trocas de cor e desenho fiel.

- Diâmetro **Ø40 mm**, furo da argola **Ø4 mm**
- Espessura **5,92 mm**, altura total **46,5 mm**
...
**Abra o `mmu.3mf`.** Ele já traz as 3 peças nomeadas e na posição certa: é só atribuir um filamento a cada uma.

| Peça | Filamento | Volume | Massa | Triângulos |
|---|---|---:|---:|---:|
| `purple` | roxo | 5.117 mm³ | 6,34 g | 21.058 |
| `white` | branco | 568 mm³ | 0,70 g | 4.442 |
| `pink` | rosa | 52 mm³ | 0,06 g | 272 |
| **total** | | **5.736 mm³** | **7,11 g** | |
