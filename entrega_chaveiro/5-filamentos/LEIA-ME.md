# 5 filamentos — chaveiro "AM Mulheres no Tatame"

Paleta cheia: cada cor do desenho tem o seu filamento.

**Quando usar:** Você tem AMS/MMU com 5 slots, ou extrusora dupla.
...
**Abra o `mmu.3mf`.** Ele já traz as 5 peças nomeadas e na posição certa: é só atribuir um filamento a cada uma.

| Peça | Filamento | Volume | Massa | Triângulos |
|---|---|---:|---:|---:|
| `purple` | roxo | 5.071 mm³ | 6,29 g | 20.362 |
| `white` | branco | 503 mm³ | 0,62 g | 3.526 |
| `skin` | pele | 57 mm³ | 0,07 g | 864 |
| `hair` | preto | 45 mm³ | 0,06 g | 1.232 |
