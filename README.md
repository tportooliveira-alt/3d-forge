...
**Pôr o sujeito pra fora.** Brilho não diz o que está na frente: num render com fundo claro,
...
`forma_mm`, `detalhe_mm`, `textos`, `sujeito_mascara`, `salto_mm`, `sujeito_borda_mm`, `formato`.
